...
public class Socks4Impl {
    ...
    public void getClientCommand() throws Exception {
        ...
        Log.d("AAA", "Accepted SOCKS 4 Command: \"" + commName(socksCommand) + "\"");
    }

    public void replyCommand(byte ReplyCode) {
        Log.d("AAA", "Socks 4 reply: \"" + replyName(ReplyCode) + "\"");
    ...
    protected void refuseCommand(byte errorCode) {
        Log.d("AAA", "Socks 4 - Refuse Command: \"" + replyName(errorCode) + "\"");
    ...
    public void connect() throws Exception {
        ...
        Log.d("AAA", "Connected to " + getSocketInfo(m_Parent.m_ServerSocket));
    ...
    public void bindReply(byte ReplyCode, InetAddress IA, int PT) {
        ...
        if (m_Parent.isActive()) {
            ...
            Log.d("AAA", "Closed BIND Client Connection");
        }
    }
    ...
    public InetAddress resolveExternalLocalIP() {
        ...
        if (m_ExtLocalIP != null) {
            ...
            try {
                ...
                Log.d("AAA", "WARNING !!! THE LOCAL IP ADDRESS WAS CHANGED !");
            }
        }
        ...
        if (IP == null) {
            Log.d("AAA", "Error in BIND() - BIND reip Failed on all common hosts to determine external IP's");
            for (Exception bindException : bindExceptions) {
                Log.d("AAA", bindException.getMessage(), bindException);
            }
        }
    ...
    public void bind() throws IOException {
        ...
        Log.d("AAA", "Local IP : " + MyIP.toString());
        ...
        try {
            ...
            Log.d("AAA", "Error in BIND() - Can't BIND at any Port");
            bindReply((byte) 92, MyIP, MyPort);
            ssock.close();
            return;
        }

        Log.d("AAA", "BIND at : <" + MyIP.toString() + ":" + MyPort + ">");
        ...
        while (socket == null) {
            if (m_Parent.checkClientData() >= 0) {
                Log.d("AAA", "BIND - Client connection closed");
                ssock.close();
                return;
            }
        ...
        Log.d("AAA", "BIND Connection from " + getSocketInfo(m_Parent.m_ServerSocket));
        ssock.close();
    }

    public void udp() throws IOException {
        Log.d("AAA", "Error - Socks 4 don't support UDP Association!");
        Log.d("AAA", "Check your Software please...");
